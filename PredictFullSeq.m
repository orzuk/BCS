% Predict full sequence chromatogram, and divide it into bins
...
%
function [tfullSeq,chromdat] = ...
    PredictFullSeq(seqInt,peakHeight,peakPos,peakwidths,peakwidthe,binning)
...
%    plot(chromdat);
    ...
    tfullSeq(cseq,:,:)=uint8(round(fullSeq(:,:)*10));
end